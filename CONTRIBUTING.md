...
The files are gitignored — a 30s GIF is around 8.5MB, well past the 500KB `check-added-large-files` limit. Publish them to [`media-assets`](https://github.com/-orchestra/releases/tag/media-assets) instead, which is where the README points:
